...
class Repo:
    ...
    Также он загружает настройки программы из файла
    """
    def __init__(self):
        """
...
def get_user(user_id):
    """
    Обработчик запроса на получение записи пользователя по id. Пример запроса:
...
def add_user(user_id):
    """
    Обработчик запроса на добавление записи пользователя по id. Пример запроса:
...
def del_user(user_id):
    """
    Обработчик запроса на удаление записи пользователя по id. Пример запроса:
...
def upd_user(user_id):
    """
    Обработчик запроса на изменение записи пользователя по id. Пример запроса:
